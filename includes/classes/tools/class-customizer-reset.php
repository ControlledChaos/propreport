...
final class Customizer_Reset {
	...
	public function scripts() {
		...
		wp_enqueue_script( 'prp-customizer-reset', PRP_URL . 'assets/js/customizer-reset' . $suffix . '.js', [ 'jquery' ], '20150120' );

		// Localize the above script.
		wp_localize_script( 'prp-customizer-reset', 'PRP_CustomizerReset', [
			'reset'   => __( 'Reset', 'propreport' ),
			'confirm' => __( 'Warning! This will remove all changes made to this theme via the Customizer. This action is irreversible.', 'propreport' ),
			'nonce'   => [
