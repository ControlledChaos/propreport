...
class User_Avatars {
	...
	public function admin_print_styles() {
		...
		.defaultavatarpicker .avatar {
			...
			background-image: url( <?php echo PRP_URL . 'assets/images/checker-bg.png' ?> );
					...
					if ( empty( $options ) || current_user_can( 'upload_files' ) ) :
						...
						if ( empty( $profileuser->uap_user_avatar ) ) {
							...
							printf(
								...
								__( 'No user avatar is set. Use the upload button to add an avatar.', 'propreport' )
							);
							...
							$delete = sprintf(
								...
								__( 'Delete local avatar', 'propreport' )
							);
							echo "<p>{$delete}</p>";

							printf(
								'<p class="description">%s</p>',
								__( 'Replace the avatar by uploading a new avatar or erase the current avatar by checking the delete option.', 'propreport' )
							);
						}
						...
						if ( empty( $profileuser->uap_user_avatar ) ) {
							printf(
								'<p class="description">%s</p>',
								__( 'You do not have permission to upload an avatar.', 'propreport' )
							);

						} else {
							printf(
								'<p class="description">%s</p>',
								__( 'You do not have media management permissions. To change your local avatar, contact the site administrator.', 'propreport' )
							);
						}
					endif;
					?>
	...
	public function get_avatar_defaults( $defaults = [] ) {
		...
		$defaults = [
			'mystery' => esc_url( PRP_URL . 'assets/images/mystery.png' ),
			'light'   => esc_url( PRP_URL . 'assets/images/mystery-light.png' ),
			'dark'    => esc_url( PRP_URL . 'assets/images/mystery-dark.png' ),
			...
			'red'     => esc_url( PRP_URL . 'assets/images/red.png' ),
			'green'   => esc_url( PRP_URL . 'assets/images/green.png' ),
			'orange'  => esc_url( PRP_URL . 'assets/images/orange.png' ),
			'black'   => esc_url( PRP_URL . 'assets/images/black.png' ),
			'white'   => esc_url( PRP_URL . 'assets/images/white.png' ),
			'gray'    => esc_url( PRP_URL . 'assets/images/gray.png' ),
			'brown'   => esc_url( PRP_URL . 'assets/images/brown.png' ),
			'tan'     => esc_url( PRP_URL . 'assets/images/tan.png' ),
			'blank'   => esc_url( PRP_URL . 'assets/images/blank.png' )
		];
	...
	public function avatar_defaults( $options = [] ) {
		...
		$options = [
			...
			$defaults['light']   => __( 'Mystery Light', 'propreport' ),
			$defaults['dark']    => __( 'Mystery Dark', 'propreport' ),
			$defaults['yellow']  => __( 'Yellow', 'propreport' ),
			$defaults['pink']    => __( 'Pink', 'propreport' ),
			$defaults['blue']    => __( 'Blue', 'propreport' ),
			$defaults['violet']  => __( 'Violet', 'propreport' ),
			$defaults['red']     => __( 'Red', 'propreport' ),
			$defaults['green']   => __( 'Green', 'propreport' ),
			$defaults['orange']  => __( 'Orange', 'propreport' ),
			$defaults['brown']   => __( 'Brown', 'propreport' ),
			$defaults['tan']     => __( 'Tan', 'propreport' ),
			$defaults['black']   => __( 'Black', 'propreport' ),
			$defaults['white']   => __( 'White', 'propreport' ),
			$defaults['gray']    => __( 'Gray', 'propreport' ),
